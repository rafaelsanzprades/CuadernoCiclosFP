      ...
      {df_ud.map((ud: UnidadDidactica) => {
        ...
        return (
          <details 
            key={ud.id_ud} 
            open={allUdsOpen} 
            className="ud-details group bg-white/5 rounded-lg border border-white/10 overflow-hidden open:bg-white/10 transition-colors"
          >
                          ...
                          <Draggable key={dragId} draggableId={dragId} index={idx}>
                            {(provided, snapshot) => (
                              <tr 
                                ...
                                className={`border-b border-white/5 hover:bg-white/5 ${snapshot.isDragging ? 'bg-background shadow-2xl z-50' : ''}`}
                              ...
                              >
                                ...
                                <td className="py-2 pr-2">
                                  <input 
                                    ...
                                    className="w-full bg-black/30 border border-white/10 rounded px-2 py-1 text-white focus:border-accent focus:outline-none" 
                                  />
                                </td>
                                <td className="py-2 pr-2">
                                  <input 
                                ...
                                <td className="py-2 pr-2">
                                  <select 
                                    ...
                                    className="w-full bg-black/30 border border-white/10 rounded px-2 py-1 text-white focus:border-accent focus:outline-none appearance-none"
                                  >
                                ...
                                <td className="py-2 pr-2">
                                  <input 
                                    ...
                                    className="w-full min-w-[200px] bg-black/30 border border-white/10 rounded px-2 py-1 text-white focus:border-accent focus:outline-none" 
                                  />
                                </td>
                                <td className="py-2 pr-2">
                                  <input 
